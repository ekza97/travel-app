                ...
                <div class="col-md-12">
                    ...
                    <div class="card border-1 border-primary">
                        ...
                        <div class="card-body p-3">
                            ...
                            <form action="{{ route('packets.update', Crypt::encrypt($edit->id)) }}" method="post"
                                id="savePacket" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="airplane_id" id="airplane_id" class="form-select mt-2 select2"
                                                ...
                                                @foreach ($airplane as $row)
                                                    @if (old('airplane_id', $edit->airplane_id) == $row->id)
                                                        <option value="{{ $row->id }}" selected>{{ $row->name }}
                                                        </option>
                                                    @else
                                                        <option value="{{ $row->id }}">{{ $row->name }}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="mekkah_hotel_id" id="mekkah_hotel_id" class="form-select mt-2 select2"
                                                ...
                                                @foreach ($hotel_mekkah as $row)
                                                    @if (old('mekkah_hotel_id', $edit->mekkah_hotel_id) == $row->id)
                                                        <option value="{{ $row->id }}" selected>
                                                            {{ $row->name }}
                                                        </option>
                                                    @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="madinah_hotel_id" id="madinah_hotel_id"
                                                ...
                                                @foreach ($hotel_madinah as $row)
                                                    @if (old('madinah_hotel_id', $edit->madinah_hotel_id) == $row->id)
                                                        <option value="{{ $row->id }}" selected>
                                                            {{ $row->name }}
                                                        </option>
                                                    @else
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control mt-2 text-capitalize" id="title"
                                                name="title" value="{{ old('title', $edit->title) }}" required autofocus>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group mt-2">
                                            ...
                                            <input type="text" class="form-control uang" id="cost" name="cost"
                                                aria-describedby="cost-addon" value="{{ old('cost', $edit->cost) }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        ...
                                        <div class="input-group mt-2">
                                            <input type="text" class="form-control angka" id="discount" name="discount"
                                                value="{{ old('discount', $edit->discount) }}"
    ...
    @push('scriptjs')
        <script>
            ...
            $('#savePacket').on('submit', function(e) {
                ...
                let link = $("#savePacket").attr('action');
                let type = "POST";
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            window.location = "{{ route('packets.index') }}";
                        });
