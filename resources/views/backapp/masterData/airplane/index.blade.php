        ...
        <div class="page-heading" style="margin-top: -20px;">
            ...
            <section class="section row">
                <div class="col-md-4">
                    <!-- Form -->
                    <div class="card">
                        <form action="" method="post" id="saveAirplane">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-2">
                                        <div class="form-group">
                                            <label for="name" class="form-label">Nama Pesawat<span
                ...
                <div class="col-md-8">
                    ...
                    <div class="card border-1 border-primary">
                        <div class="card-header border-bottom p-3 pb-1">
                            <h4 class="card-title">Daftar Pesawat</h4>
                        </div>
    ...
    @push('scriptjs')
        <script>
            ...
            function editData(id) {
                $('[name="name"]').focus();
                var link = "{{ route('airplanes.edit', ':id') }}";
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#saveAirplane").attr('action', response.link);
            ...
            $('#saveAirplane').on('submit', function(e) {
                ...
                var link = $("#saveAirplane").attr('action');
                let type = "PUT";
                if (link == "") {
                    link = "{{ route('airplanes.store') }}";
                    type = "POST";
                }
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#airplane-table').DataTable().ajax.reload(null, false);
                        $('[name="name"]').focus();
            ...
            $(document).on('click', '#deleteAirplane', function(e) {
                e.preventDefault();
