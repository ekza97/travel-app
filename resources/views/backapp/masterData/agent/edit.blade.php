            ...
            <section class="section row">
                <div class="col-md-12">
                    ...
                    <div class="card border-1 border-primary">
                        <div class="card-header border-bottom p-2 pb-2 d-flex justify-content-between">
                            <a href="{{ route('agents.index') }}" class="btn btn-sm btn-secondary">
                                <i class="bi bi-arrow-left"></i>
                                Kembali
                            </a>
                            @if ($edit->image != null)
                                <a href="{{ asset('') . 'storage/agent/' . Helper::getFilename($edit->image) }}"
                                    class="btn btn-sm btn-info" data-lightbox="{{ Helper::getFilename($edit->image) }}"
                                    target="_blank">
                                    <i class="bi bi-eye"></i>
                                    Lihat Image
                                </a>
                        ...
                        <div class="card-body p-3">
                            ...
                            <form action="{{ route('agents.update', Crypt::encrypt($edit->id)) }}" method="post" id="saveAgent"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control text-uppercase" id="token"
                                                name="token" value="{{ old('token', $edit->token) }}" required readonly>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control text-capitalize" id="fullname"
                                                name="fullname" value="{{ old('fullname', $edit->fullname) }}"
                                                placeholder="John Andy" required autofocus>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control text-capitalize" id="pob"
                                                name="pob" value="{{ old('pob', $edit->pob) }}" placeholder="Bintuni"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control flatpicker" id="dob" name="dob"
                                                max="{{ date('Y-m-d') }}" value="{{ old('dob', $edit->dob) }}"
                                                placeholder="2023-01-23" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control phone" id="phone" name="phone"
                                                value="{{ old('phone', $edit->phone) }}" placeholder="0812xxxxxxxx"
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="address" id="address" cols="30" rows="5" class="form-control" required>{{ old('address', $edit->address) }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" name="is_active" id="is_active">
                                                        <option value="1" {{ $edit->is_active == 1 ? 'selected' : '' }}>
                                                            Aktif
                                                        </option>
                                                        <option value="0" {{ $edit->is_active == 0 ? 'selected' : '' }}>
                                                            Tidak Aktif</option>
                                                    </select>
                                                </div>
                                            </div>
    ...
    @push('scriptjs')
        <script>
            ...
            $('#saveAgent').on('submit', function(e) {
                ...
                let link = $("#saveAgent").attr('action');
                let type = "POST";
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            window.location = "{{ route('agents.index') }}";
                        });
