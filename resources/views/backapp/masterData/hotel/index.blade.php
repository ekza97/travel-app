        ...
        <div class="page-heading" style="margin-top: -20px;">
            ...
            <section class="section row">
                <div class="col-md-4">
                    <!-- Form -->
                    <div class="card">
                        <form action="" method="post" id="saveHotel">
                            @csrf
                            <div class="card-header border-bottom p-3 pb-1 mb-4">
                                <h4 class="card-title">Form Hotel</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-2">
                                        <div class="form-group">
                                            <label for="name" class="form-label">Nama Hotel<span
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            <label for="type" class="form-label">Lokasi<span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="url" class="form-control" id="location" name="location"
                                                value="{{ old('location') }}" minlength="3">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    @push('scriptjs')
        <script>
            ...
            function editData(id) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#saveHotel").attr('action', response.link);
            ...
            $('#saveHotel').on('submit', function(e) {
                ...
                var link = $("#saveHotel").attr('action');
                let type = "PUT";
                if (link == "") {
                    link = "{{ route('hotels.store') }}";
                    type = "POST";
                }
                let name = $('[name="name"]').val();
                let lokasi = $('[name="type"]').val();
                let gmaps = $('[name="location"]').val();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#hotel-table').DataTable().ajax.reload(null, false);
                        $('[name="name"]').focus();
