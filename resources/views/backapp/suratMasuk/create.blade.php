<div class="modal fade" id="formModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form id="saveSuratMasuk" action="" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                    <h4 class="modal-title mt-n3">Tambah Surat Masuk</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="row p-1">
                        <div class="col-md-6 mb-3">
                            <label class="form-label" for="jenis_surat_id">Jenis Surat<span
                                    class="text-danger">*</span></label>
                            <select class="form-select select2" id="jenis_surat_id" name="jenis_surat_id" required>
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
