<div class="modal fade" id="formEditModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form id="editSuratMasuk" action="" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="modal-header">
                    <h4 class="modal-title mt-n3">Edit Surat Masuk</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="row p-1">
                        <div class="col-md-6 mb-3">
                            <label class="form-label" for="edit_jenis_surat_id">Jenis Surat<span
                                    class="text-danger">*</span></label>
                            <select class="form-select select2" id="edit_jenis_surat_id" name="jenis_surat_id" required>
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label" for="tujuan">Tujuan Surat<span
                                    class="text-danger">*</span></label>
                            <input type="text" id="tujuan" name="tujuan" class="form-control" autofocus required>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-2">
                            <label class="form-label" for="file">File Surat</label>
                            <input type="file" id="file" name="file" class="form-control" accept=".pdf">
                            <p class="text-muted mb-0">Ukuran maksimal file <strong>2 MB</strong>. Type file yang
                                diizinkan <strong>.pdf</strong></p>
                            <p class="text-danger">
                                Biarkan kosong jika tidak ingin merubah File Surat. <a href="" id="lihat-file"
