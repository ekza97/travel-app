...
class SuratMasukDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($row){
            $action = '';
            if(Gate::allows('edit surat_masuk')){
            ...
            if(Gate::allows('delete surat_masuk')){
            $action .= '<form method="post" action="' . route("letter-in.destroy", Crypt::encrypt($row->id)) . '"
                id="deleteSuratMasuk" style="display:inline" data-bs-toggle="tooltip"
