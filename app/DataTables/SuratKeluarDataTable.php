...
class SuratKeluarDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($row){
            $action = '';
            if(Gate::allows('edit surat_keluar')){
            ...
            if(Gate::allows('delete surat_keluar')){
            $action .= '<form method="post" action="' . route("letter-out.destroy", Crypt::encrypt($row->id)) . '"
                id="deleteSuratKeluar" style="display:inline" data-bs-toggle="tooltip"
