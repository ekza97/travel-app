...
class HotelDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($row){
            ...
            if(Gate::allows('delete hotel')){
            $action .= '<form method="post" action="' . route("hotels.destroy", Crypt::encrypt($row->id)) . '"
                id="deleteHotel" style="display:inline" data-bs-toggle="tooltip"
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('name')->title('Nama Hotel'),
            Column::make('type')->title('Lokasi'),
            Column::make('location')->title('Gmaps'),
